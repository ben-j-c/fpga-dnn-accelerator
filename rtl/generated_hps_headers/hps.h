...
#define SYSTOLIC_CORE_SPAN 1024
#define SYSTOLIC_CORE_END 0x3ff
...
/*
 * Macros for device 'msgdma_write_csr', class 'altera_msgdma'
 * The macros are prefixed with 'MSGDMA_WRITE_CSR_'.
 * The prefix is the slave descriptor.
 */
#define MSGDMA_WRITE_CSR_COMPONENT_TYPE altera_msgdma
#define MSGDMA_WRITE_CSR_COMPONENT_NAME msgdma_write
#define MSGDMA_WRITE_CSR_BASE 0x2040
#define MSGDMA_WRITE_CSR_SPAN 32
#define MSGDMA_WRITE_CSR_END 0x205f
#define MSGDMA_WRITE_CSR_BURST_ENABLE 1
#define MSGDMA_WRITE_CSR_BURST_WRAPPING_SUPPORT 0
#define MSGDMA_WRITE_CSR_CHANNEL_ENABLE 0
#define MSGDMA_WRITE_CSR_CHANNEL_ENABLE_DERIVED 0
#define MSGDMA_WRITE_CSR_CHANNEL_WIDTH 8
#define MSGDMA_WRITE_CSR_DATA_FIFO_DEPTH 512
#define MSGDMA_WRITE_CSR_DATA_WIDTH 256
#define MSGDMA_WRITE_CSR_DESCRIPTOR_FIFO_DEPTH 16
#define MSGDMA_WRITE_CSR_DMA_MODE 2
#define MSGDMA_WRITE_CSR_ENHANCED_FEATURES 1
#define MSGDMA_WRITE_CSR_ERROR_ENABLE 0
#define MSGDMA_WRITE_CSR_ERROR_ENABLE_DERIVED 0
#define MSGDMA_WRITE_CSR_ERROR_WIDTH 8
#define MSGDMA_WRITE_CSR_MAX_BURST_COUNT 128
#define MSGDMA_WRITE_CSR_MAX_BYTE 8192
#define MSGDMA_WRITE_CSR_MAX_STRIDE 1
#define MSGDMA_WRITE_CSR_PACKET_ENABLE 0
#define MSGDMA_WRITE_CSR_PACKET_ENABLE_DERIVED 0
#define MSGDMA_WRITE_CSR_PREFETCHER_ENABLE 0
#define MSGDMA_WRITE_CSR_PROGRAMMABLE_BURST_ENABLE 0
#define MSGDMA_WRITE_CSR_RESPONSE_PORT 2
#define MSGDMA_WRITE_CSR_STRIDE_ENABLE 0
#define MSGDMA_WRITE_CSR_STRIDE_ENABLE_DERIVED 0
#define MSGDMA_WRITE_CSR_TRANSFER_TYPE Aligned Accesses

/*
 * Macros for device 'msgdma_write_descriptor_slave', class 'altera_msgdma'
 * The macros are prefixed with 'MSGDMA_WRITE_DESCRIPTOR_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_COMPONENT_TYPE altera_msgdma
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_COMPONENT_NAME msgdma_write
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_BASE 0x2060
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_SPAN 32
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_END 0x207f
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_BURST_ENABLE 1
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_BURST_WRAPPING_SUPPORT 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_CHANNEL_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_CHANNEL_ENABLE_DERIVED 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_CHANNEL_WIDTH 8
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_DATA_FIFO_DEPTH 512
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_DATA_WIDTH 256
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_DESCRIPTOR_FIFO_DEPTH 16
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_DMA_MODE 2
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_ENHANCED_FEATURES 1
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_ERROR_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_ERROR_ENABLE_DERIVED 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_ERROR_WIDTH 8
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_MAX_BURST_COUNT 128
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_MAX_BYTE 8192
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_MAX_STRIDE 1
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_PACKET_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_PACKET_ENABLE_DERIVED 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_PREFETCHER_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_PROGRAMMABLE_BURST_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_RESPONSE_PORT 2
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_STRIDE_ENABLE 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_STRIDE_ENABLE_DERIVED 0
#define MSGDMA_WRITE_DESCRIPTOR_SLAVE_TRANSFER_TYPE Aligned Accesses

...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/ben/Soft/intelFPGA_lite/22.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/sc_fifo_cols/
mkdir -p ./libraries/pio_0/
mkdir -p ./libraries/msgdma_write/
mkdir -p ./libraries/msgdma_read/
mkdir -p ./libraries/hps_0/
mkdir -p ./libraries/fifo_instr/
mkdir -p ./libraries/demux_cols_rows/
mkdir -p ./libraries/clk_95/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter.v"                          -work avalon_st_adapter         -cdslib ./cds_libs/avalon_st_adapter.cds.lib        
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                 -work sc_fifo_cols              -cdslib ./cds_libs/sc_fifo_cols.cds.lib             
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pio_0.v"                                      -work pio_0                     -cdslib ./cds_libs/pio_0.cds.lib                    
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_msgdma_write.v"                               -work msgdma_write              -cdslib ./cds_libs/msgdma_write.cds.lib             
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_msgdma_read.v"                                -work msgdma_read               -cdslib ./cds_libs/msgdma_read.cds.lib              
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_fifo_instr.v"                                 -work fifo_instr                -cdslib ./cds_libs/fifo_instr.cds.lib               
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_demux_cols_rows.sv"                           -work demux_cols_rows           -cdslib ./cds_libs/demux_cols_rows.cds.lib          
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_clk_95.vo"                                    -work clk_95                    -cdslib ./cds_libs/clk_95.cds.lib                   

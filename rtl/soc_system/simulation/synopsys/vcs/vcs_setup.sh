...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/soc_system_pio_0.v \
  $QSYS_SIMDIR/submodules/soc_system_msgdma_write.v \
  $QSYS_SIMDIR/submodules/soc_system_msgdma_read.v \
  $QSYS_SIMDIR/submodules/soc_system_hps_0.v \
  $QSYS_SIMDIR/submodules/soc_system_fifo_instr.v \
  $QSYS_SIMDIR/submodules/soc_system_demux_cols_rows.sv \
  $QSYS_SIMDIR/submodules/soc_system_clk_95.vo \

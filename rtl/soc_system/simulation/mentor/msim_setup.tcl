...
# ----------------------------------------
# ACDS 22.1 915 linux 2023.03.27.02:11:04
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/ben/Soft/intelFPGA_lite/22.1std/quartus/"
}
...
ensure_lib                           ./libraries/sc_fifo_cols/             
vmap       sc_fifo_cols              ./libraries/sc_fifo_cols/             
ensure_lib                           ./libraries/pio_0/                    
vmap       pio_0                     ./libraries/pio_0/                    
ensure_lib                           ./libraries/msgdma_write/             
vmap       msgdma_write              ./libraries/msgdma_write/             
ensure_lib                           ./libraries/msgdma_read/              
vmap       msgdma_read               ./libraries/msgdma_read/              
ensure_lib                           ./libraries/hps_0/                    
vmap       hps_0                     ./libraries/hps_0/                    
ensure_lib                           ./libraries/fifo_instr/               
vmap       fifo_instr                ./libraries/fifo_instr/               
ensure_lib                           ./libraries/demux_cols_rows/          
vmap       demux_cols_rows           ./libraries/demux_cols_rows/          
ensure_lib                           ./libraries/clk_95/                   
vmap       clk_95                    ./libraries/clk_95/                   
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter.v"                                                       -work avalon_st_adapter        
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                              -work sc_fifo_cols             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pio_0.v"                                                                   -work pio_0                    
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_msgdma_write.v"                                                            -work msgdma_write             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_msgdma_read.v"                                                             -work msgdma_read              
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_fifo_instr.v"                                                              -work fifo_instr               
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_demux_cols_rows.sv"                           -L altera_common_sv_packages -work demux_cols_rows          
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_clk_95.vo"                                                                 -work clk_95                   
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L fpga_interfaces -L rst_controller -L avalon_st_adapter -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L sc_fifo_cols -L pio_0 -L msgdma_write -L msgdma_read -L hps_0 -L fifo_instr -L demux_cols_rows -L clk_95 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L fpga_interfaces -L rst_controller -L avalon_st_adapter -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L sc_fifo_cols -L pio_0 -L msgdma_write -L msgdma_read -L hps_0 -L fifo_instr -L demux_cols_rows -L clk_95 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
